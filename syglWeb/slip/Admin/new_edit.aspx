<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="new_edit.aspx.cs" Inherits="syglWeb.slip.Admin.new_edit" %>
...
<form id="newsEditForm" runat="server">
    <div style="margin:3px;line-height:2em;">
        <table class="edit_table">
            ...
            <tbody>
                <tr><td class="title">标题</td><td><asp:textbox id="newsTitle" runat="server" CssClass="input_tb h30 w70per lh30 font14"></asp:textbox></td></tr>
               
                <tr><td  class="title">发布日期</td><td><asp:textbox id="newsPostTime" runat="server" CssClass="input_tb h30 w50per lh30 font14"></asp:textbox> </td></tr>
                <tr><td  class="title">内容</td><td><asp:textbox id="newsContent"  runat="server" CssClass="input_tb  w70per" style="height:260px" TextMode="MultiLine"></asp:textbox> </td></tr>                 
            </tbody>
        </table>
    </div>
