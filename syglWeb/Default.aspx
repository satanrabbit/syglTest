...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
        ...
        <div class="subdoors">
            <ul>
                <li class="longTile"><a href="#" class="subdoor" ><i id="door1" class="door1">.</i><span class="sdtext">资产管理系统</span></a></li>
                <li class="longTile"><a href="#" class="subdoor" ><i id="door2" class="door2">.</i><span class="sdtext">易耗品申领系统</span></a></li>
                <li class="longTile"><a href="#" class="subdoor" ><i id="door3" class="door3">.</i><span class="sdtext">大型仪器预约系统</span></a></li>
                <li class="longTile"><a href="#" class="subdoor" ><i id="door6" class="door6">.</i><span class="sdtext">资产上报系统</span></a></li>
                 <li class="shortTile"><a href="/slip/" target="_blank" class="subdoor" ><i id="door4" class="door4">.</i><span class="sdtext">创新平台</span></a></li>
                <li class="shortTile"><a href="#" class="subdoor" ><i id="door5" class="door5">.</i><span class="sdtext">示范中心</span></a></li>
            </ul>
            <script type="text/javascript">
                $(function () {
