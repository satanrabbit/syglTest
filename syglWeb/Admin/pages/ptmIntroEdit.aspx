<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ptmIntroEdit.aspx.cs" Inherits="syglWeb.Admin.pages.ptmIntroEdit" %>
...
<form id="articleEditForm" runat="server">
    <div style="margin:3px;line-height:2em;">
        <table class="edit_table">
            ...
            <tbody>                
                <tr><td><asp:textbox id="articleContent"  runat="server" CssClass="input_tb  w70per" style="height:360px" TextMode="MultiLine"></asp:textbox> </td></tr>                 
            </tbody>
        </table>
    </div> 
 </form>
