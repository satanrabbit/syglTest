<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Site.Master" AutoEventWireup="true" CodeBehind="DownList.aspx.cs" Inherits="syglWeb.DownList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="layout"> 
        <div class="chief fl"> 
            <div class="">
                <h1>
                    <asp:HyperLink ID="HyperLinkClmTitle" runat="server" CssClass="h1title" NavigateUrl="downList.aspx">文档下载</asp:HyperLink>
                </h1>
                <ul>
                    <asp:Repeater ID="RepeaterList" runat="server" OnItemDataBound="RepeaterList_ItemDataBound">
                        <ItemTemplate>
                            <li>
                                <h4><asp:HyperLink ID="HyperLinkDownTitle" runat="server"></asp:HyperLink></h4>
                                <asp:Label ID="LabelDownIntro" runat="server" Text="" CssClass="l23"></asp:Label>
