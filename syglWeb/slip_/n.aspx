<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="n.aspx.cs" Inherits="syglWeb.slip_.n" %>
            ...
            <div class="ui-grid-18">
                ...
                <div class="help-detail">
        			<h2 class="detail-title">
        				<asp:Label runat="server" ID="newsTitle"></asp:Label>
        			</h2>
        			<div class="detail-content">
                        <asp:Label runat="server" ID="newsContent">
                        </asp:Label>
        			</div> 
		</div>
            </div>
